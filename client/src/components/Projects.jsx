      ...
      <section className={styles.codeSection} id="code">
        <div className={styles.sectionHeader}>
          <div>
            ...
            <h2 className="section-title">Coding <em>Projects</em></h2>
            <p className="section-sub">Apps, tools, and experiments — real things that actually run.</p>
          </div>
      ...
      <section className={styles.designSection} id="design">
        <div className={styles.sectionHeader}>
          <div>
            ...
            <h2 className="section-title">Design <em>Projects</em></h2>
            <p className="section-sub">Visual identities, interfaces, illustrations — things made to be felt.</p>
          </div>
          <div className={styles.filters}>
