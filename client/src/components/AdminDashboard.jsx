...
export default function AdminDashboard() {
  ...
  // ── MODAL ──
  const openAdd = () => {
    setForm(EMPTY_PROJECT); setEditId(null);
            ...
            <div style={s.table}>
              ...
              {filtered.map(p => (
                <div key={p._id} style={s.tableRow}>
                  ...
                  <span style={{flex:1}}>
                    <span style={{...s.badge,
                      background: p.type==="code"?"rgba(91,163,204,.2)":"rgba(242,164,165,.2)",
                  ...
                  <span style={{flex:1}}>
                    {p.featured && <span style={{...s.badge,background:"rgba(242,164,165,.15)",color:"#F2A4A5"}}>★</span>}
                  </span>
            ...
            <form onSubmit={saveProject} style={s.formGrid}>
              ...
              <div style={s.formGroup}>
                ...
                <select style={s.input} value={form.type}
                  onChange={e => setForm(f=>({...f,type:e.target.value,category:e.target.value==="code"?"web":"Branding"}))}>
...
const s = {
  ...
  uploadLabel:     { display:"inline-flex", alignItems:"center", gap:"0.5rem", background:"rgba(91,163,204,.15)", color:"#7ec8e8", border:"1px solid rgba(91,163,204,.25)", padding:"0.6rem 1.2rem", borderRadius:"0.6rem", fontSize:"0.82rem", cursor:"pointer", transition:"all 0.2s", width:"fit-content" },
