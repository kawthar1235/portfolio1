    ...
    <section className={styles.about} id="about" ref={ref}>
      ...
      <div className={`${styles.content} fade-up`}>
        ...
        <blockquote className={styles.quote}>
          {lang === 'ar'
            ? '"البرمجيات الرائعة هي حيث تعمل الإبداعية وسهولة الاستخدام والتكنولوجيا معاً بسلاسة."'
        ...
        <div className={styles.tags} style={{display:'flex', gap:'3rem', flexWrap:'wrap', alignItems:'flex-start'}}>
          {TAGS.map((group) => (
